                                ...
                                <tr key={`${trend.container_id}-${trend.metric_type}`} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="flex items-center">
                                            ...
                                            <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${trend.direction === 'increasing' ? 'bg-red-100 text-red-800' :
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${trend.confidence === 'high' ? 'bg-green-100 text-green-800' :
                            ...
                            <div className="flex items-start justify-between">
                                <div className="flex-1">
                                    ...
                                    <div className="mt-2 flex items-center space-x-4">
                                        ...
                                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${opt.optimization_type === 'increase' ? 'bg-red-100 text-red-800' :
                                        ...
                                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${opt.impact_level === 'high' ? 'bg-red-100 text-red-800' :
