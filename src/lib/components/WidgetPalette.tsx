                                ...
                                >
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex items-center justify-between">
                                            <span className={`inline-flex px-2 py-1 text-xs rounded-full ${categoryColors[widget.category] || 'bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300'
                                                }`}>
                                                {widget.category}
                                            </span>
